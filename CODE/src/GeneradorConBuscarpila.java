...
public class GeneradorConBuscarpila
{
    ...
    */
    ...
    public static void main(String[] args)
    {
       ...
       add=solve.genSt(initState, instrucciones.derecha);
        ...
        buscarpilas.buscarpila(initState).toString();
        System.out.print("\nFINISHED SEARCHING\n_____________________\n\n");
        
        System.out.print("\nsearching through ArrayList: \n");
       
        buscarpilas.buscarpilaConArray(initState).toString();
        System.out.print("\nFINISHED SEARCHING\n_____________________\n\n");
    }
    public static class buscarpilas
    {
    	...
    	public static ArrayList<State> buscarpilaConArray(State finalstate)
    	{
    		...
    		while(!al.isEmpty() && !currState.equals(finalstate) )
    		{
    			currState=al.remove(0);
    			toreturn.add(currState);
    			if(currState.vecinos.containsKey("arriba"))
    			{
