...
public class Generador3 {
    ...
    */
    ...
    public State setInitSt() {
        ...
        for (int i = 0; i < face; i++) {     //N̼mero de cara siendo llenada
            for (int j = 0; j < rows; j++) {      //N̼mero de fila siendo llenada
                System.out.print("\n");

                for (int k = 0; k < cols; k++) {   //N̼mero de columna siendo llenada
