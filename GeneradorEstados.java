...
public class GeneradorEstados 
{
    ...
    /*Dimensiones*/
    final int cols = 2; //Número de filas por cara
    final int rows = 2; //Número de columnas por cara
    ...
    */
    ...
    public State setInitSt(){
       ArrayList<Integer> numeros = new ArrayList<Integer>();
        ...
        for (int i = 0; i < face; i++)
        {     //Número de cara siendo llenada
            for(int j=0; j<rows; j++)
            {      //Número de fila siendo llenada
                System.out.print("\n");

                for(int k=0; k<cols;k++)
                {   //Número de columna siendo llenada
